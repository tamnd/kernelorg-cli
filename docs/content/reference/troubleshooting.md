...
Most of these come down to network reality or how kernelorg serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

kernelorg rate-limits like any public site. kernel already paces
...
Where a surface is gated, kernel reads a cookie or token you supply
...
`kernel`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what kernel actually did
